                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.H2("...", id="heart-rate", style={"color": "green", "font-size": "50px"}), # Heart rate to be updated here
                ...
                dbc.Col(
                    html.Div(
                        [
                            ...
                            html.H1("36.9°C", id="temperature-value", className="value"), # Temperature to be updated here
                        ],
                        className="data-box"
                    ),
                    width={"size": 6},
