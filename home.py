    ...
    [
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    dbc.Button("View Patient History", color="primary", className="action-btn", href="https://supabase.com/dashboard/project/ysthgyildvykrrxyremj/editor/29023?schema=public", target="_blank"),
